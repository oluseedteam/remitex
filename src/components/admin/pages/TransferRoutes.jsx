...
export default function TransferRoutes() {
  ...
  const totalVolume = routes.reduce((sum, r) => sum + parseFloat(r.exchange_rate || 0), 0);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-3xl font-bold text-gray-900" style={{ fontFamily: 'Outfit, sans-serif' }}>
              {routes.length > 0 ? (totalVolume / routes.length).toFixed(2) : '0.00'}
            </h3>
          </div>
        </div>
